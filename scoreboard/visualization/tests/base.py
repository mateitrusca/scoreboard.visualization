...
def setup_product():
    ...
    import scoreboard.visualization
    zcml.load_config('configure.zcml', scoreboard.visualization)
    ...
    ztc.installPackage('scoreboard.visualization')
...
setup_product()
ptc.setupPloneSite(products=['scoreboard.visualization'])
